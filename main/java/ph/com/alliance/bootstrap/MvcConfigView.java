...
import ph.com.alliance.interceptors.BoardInterceptor;
import ph.com.alliance.interceptors.HomeInterceptor;
...
public class MvcConfigView extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
	    ...
	    registry.addInterceptor(new HomeInterceptor()).addPathPatterns("/").addPathPatterns("/login").addPathPatterns("/register");
	}
	@Bean
